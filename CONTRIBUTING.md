...
We welcome contributions to "nosy" and greatly appreciate your help in making
...
[nosy repository](https://github.com/ynqa/nosy) to create a copy of the
...
```bash
git clone https://github.com/<your_username>/nosy.git
```
...
[nosy Pull Request page](https://github.com/ynqa/nosy/pulls) and click the
...
Thank you for considering contributing to "nosy"!
